  ...
  always_comb begin
    ...
    unique case (opcode)
      OPCODE_OP: begin
        ...
        decoded_uop_o.int_ctrl.operand_a_select = OPA_RS1;
        decoded_uop_o.int_ctrl.operand_b_select = OPB_RS2;
      ...
      OPCODE_OP_IMM: begin
        ...
        decoded_uop_o.int_ctrl.operand_a_select = OPA_RS1;
        decoded_uop_o.int_ctrl.operand_b_select = OPB_IMM;
      ...
      OPCODE_LUI: begin
        ...
        decoded_uop_o.int_ctrl.operand_a_select = OPA_ZERO;
        decoded_uop_o.int_ctrl.operand_b_select = OPB_IMM;
      end
      ...
      OPCODE_AUIPC: begin
        ...
        decoded_uop_o.writes_rd                 = (rd_addr != '0);
        decoded_uop_o.imm                       = u_type_imm;
        decoded_uop_o.int_ctrl.operand_a_select = OPA_PC;
        decoded_uop_o.int_ctrl.operand_b_select = OPB_IMM;
      end
